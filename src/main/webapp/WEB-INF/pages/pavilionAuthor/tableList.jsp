...
<th data-column-id="name" data-width="6%">作者姓名</th>
<th data-column-id="photoUrl" data-width="8%" data-converter="showImage">作者照片</th>
<%--<th data-column-id="hasPhoto" data-width="6%" data-converter="showYes">是否有照片</th>--%>
