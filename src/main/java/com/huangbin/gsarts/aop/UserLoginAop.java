...
import com.huangbin.gsarts.domain.userLog.UserLogService;
...
public class UserLoginAop {
     ...
     */
    @AfterReturning(value = "execution(* com.huangbin.gsarts.controller.app.LoginController.login(..))", returning = "loginResult")
     ...
     * @param joinPoint
     */
    @Before(value = "execution(* com.huangbin.gsarts.controller.app.LoginController.logout(..))")
